    ...
    <FooterTag>
      <FullW>
        <NavLinks>
          ...
          <span>|</span>
          <MShow to="/test">About JoongBu</MShow>
        </NavLinks>
      </FullW>
      <InnerWClf>
        <LogoFooter>{/* <LogoGray /> */}</LogoFooter>
        <Fl>
          <FooterStrong>(주) 두반장</FooterStrong>
          <FooterUl>
            <FooterLi>대표이사 : 정석현</FooterLi>
            {/* <FooterLi>서울특별시 마포구 동교로 19길 12</FooterLi>
            <FooterLi>사업자 등록번호 : 107-87-83297</FooterLi>
            <FooterLi>통신판매업신고 : 2015-서울마포-0440</FooterLi> */}
          </FooterUl>
          <NtFix1>
            중부장터는 통신판매중개자이며 통신판매의 당사자가 아닙니다.
            <br />
            따라서 중부장터는 상품 거래정보 및 거래에 대하여 책임을 지지
            않습니다.
        ...
        <Fl>
          ...
          <NtFix1>
            이용 중 궁금하신 점이 있으신가요?
            <br />
            메일 또는 플러스친구 `중부장터`로 연락해주세요.
            <br />
            최선을 다해 도와드리겠습니다.
          </NtFix1>
        </Fl>
        <Fr>
          <FooterStrong>참고</FooterStrong>
          <NavList>
            {/* <LinkFacebook
            ...
            <LinkNaverBlog
              className="icon-blog"
              href="https://blog.naver.com/audwls714"
            />
          </NavList>
        </Fr>
      </InnerWClf>
